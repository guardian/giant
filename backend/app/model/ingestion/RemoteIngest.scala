...
case class RemoteIngest(id: String, title: String, status: String, workspaceId: String, parentFolderId: String, collection: String, ingestion: String, timeoutAt: DateTime, url: String, userEmail: String)
