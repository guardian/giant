...
case class DocumentResultDetails(mimeTypes: Seq[String], displayMimeTypes: Seq[String], fileCategory: String, fileUris: Seq[String], fileSize: Option[Long]) extends ResultDetails
