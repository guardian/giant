...
object Binders {
  implicit val offsetDateTimeBindable: PathBindable[OffsetDateTime] = new PathBindable[OffsetDateTime] {
  ...
  implicit def pathBindable(implicit stringBinder: PathBindable[String]): PathBindable[Uri] = new PathBindable[Uri] {
  ...
  implicit def languageBindable(implicit stringBinder: PathBindable[String]): PathBindable[Language] = new PathBindable[Language] {
  ...
  implicit def languageQueryStringBindable(implicit stringBinder: QueryStringBindable[String]): QueryStringBindable[Language] = new QueryStringBindable[Language] {
