...
import {
  createDatabaseProviderGenesisUser,
  createPandaProviderGenesisUser,
} from "../../actions/users/createGenesisUser";

export class CreateGenesisUserUnconnected extends React.Component<any, any> {
  static propTypes = {
    config: config,
...
function mapDispatchToProps(dispatch) {
  return {
    createDatabaseUser: bindActionCreators(
      createDatabaseProviderGenesisUser,
      dispatch,
    ),
    createPandaUser: bindActionCreators(
      createPandaProviderGenesisUser,
      dispatch,
    ),
  };
...
export const CreateGenesisUser = connect(
  mapStateToProps,
  mapDispatchToProps,
)(CreateGenesisUserUnconnected);
