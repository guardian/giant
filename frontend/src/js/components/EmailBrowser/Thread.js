...
class Thread extends React.Component {
    ...
    uriInCurrentThread = (uri) => this.props.emails.timeline.thread.some(t => t.email.uri === uri)

    componentDidUpdateOrMount() {
        if (!this.props.emails || !this.uriInCurrentThread(this.props.match.params.uri)) {
    ...
    shouldComponentUpdate(newProps) {
        return this.props.match.params.uri !== newProps.match.params.uri ||
            ...
            return(
                <div className='app__main-content'>
                    <div className='app__section'>
                        <div>
                            <Timeline data={emailThread.timeline}
                            onSelect={this.select} selected={this.props.match.params.uri}/>
                        </div>
                    </div>
...
function mapDispatchToProps(dispatch) {
    return {
        emailsActions: bindActionCreators(Object.assign({}, getEmailThread), dispatch)
    };
}
