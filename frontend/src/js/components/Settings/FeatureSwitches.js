...
export const features = [
    { name: "PageViewer", description: "Use new text viewer that understands pages" },
    { name: "EUI", description: "Use new EUI-based components (requires page reload to fix styles)" }
];
    ...
    renderRow = (feature) => {
        ...
        return (
            <tr className='date-table__row' key={feature.name}>
                ...
                <td align='center'>
                    <input type='checkbox' checked={value} onChange={(e) => this.toggleFeatureSwitch(e, feature.name)}/>
                </td>
            </tr>
        );
    }
                ...
                <table className='data-table'>
                    <thead>
                        <tr className='data-table__row'>
                            <th className='data-table__item data-table__item--title'>Feature</th>
                            <th className='data-table__item data-table__item--title'>Description</th>
                            <th className='data-table__item data-table__item--title'>Status</th>
                        </tr>
                    </thead>
                    <tbody>
                        {features.map(f => this.renderRow(f))}
                    </tbody>
                </table>
            </div>
        );
