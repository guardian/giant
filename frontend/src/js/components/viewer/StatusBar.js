  ...
  renderSearchResultNavigation = () => {
    ...
    if (
      ...
      return (
        <span>
          {buttons}
          <span className="document__status-text">
            Result {this.props.currentHighlight + 1} of{" "}
            {this.props.totalHighlights}
          </span>
        </span>
      );
      ...
      return (
        <span>
          {buttons}
          <span className="document__status-text">
            {this.props.totalHighlights} results
          </span>
        </span>
      );
    } else {
    ...
    return (
      <div className="document__status">
        <KeyboardShortcut
          ...
          func={this.previousSearchHighlight}
        />
        <KeyboardShortcut
