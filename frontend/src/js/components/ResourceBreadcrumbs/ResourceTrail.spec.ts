...
test("Create segments for directory", () => {
    ...
    const segments = [
        ...
        { uri: 'collection/ingestion/an/encoded$20%23%20folder', display: 'encoded # folder' },
    ];
...
test("Create default segments for blob", () => {
    const uri = 'v66OEG5v1dRsQwNfaaPfq-V50wYP3b07Ns9CVznKM9JhOaPAT3FFEctsCgcTm1c1c7kt5Pa_QHHkPwxEg-lviw';
    const resource: BasicResource = {
        type: 'blob', uri, isExpandable: false, processingStage: { type: 'processed' }
    };
