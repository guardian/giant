...
export default class SearchBox extends React.Component {
    ...
    render () {
        const spinner = this.props.isSearchInProgress ? <ProgressAnimation /> : false;
        return (
            <div>
                <div className='search-box'>
                    <InputSupper ref={s => this.searchInput = s} className='search-box__input' value={this.props.q} chips={this.props.suggestedFields} onChange={this.props.updateVisibleText} updateSearchText={this.props.updateSearchText}/>
