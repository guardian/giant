...
export default class InlineInput extends React.Component<any, any> {
  textInput: any;
  static propTypes = {
  ...
  render() {
    return (
      <span
        className="input-supper__input-wrapper"
        onClick={this.onClickWrapper}
        onDoubleClick={this.onDoubleClickWrapper}
      >
        <AutosizeInput
