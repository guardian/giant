  ...
  render() {
    ...
    return (
      <div className="file-browser__wrapper">
            ...
            <thead>
              <tr>
                {this.props.columnsConfig.columns.map((c) => {
                  ...
                  const style = Object.assign({}, c.style, {
                    width: widthCalc,
                  });
                  ...
                  return (
                    <th
                      key={c.name}
                      className="file-browser__header"
                      style={style}
                      onClick={(e) => this.onClickColumn(e, c.name)}
                    >
                      <div
                        className="file-browser__header-resizer"
                        onMouseDown={(e) => this.resizeMouseDown(e, c.name)}
        ...
        <div
          className={`file-browser__highlighter ${this.state.hoveredOver ? "file-browser__root-drop-highlight" : ""}`}
        />
        <div
          onClick={this.props.clearFocus}
          onDragOver={this.onDragOver}
          onDragLeave={this.onDragLeave}
          onDrop={(e) => this.onDrop(e, this.props.rootId)}
          className="file-browser__extender"
        />
      </div>
    );
  }
