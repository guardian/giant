...
class HoverSearchLinkUnconnected extends React.Component<any, any> {
  static propTypes = {
  ...
  render() {
    ...
    const link = buildLink("/search", this.props.urlParams, {
      q: query,
      page: "1",
    });
    ...
    return (
      <Link
        className="hover-search-link hover-show"
        to={link}
