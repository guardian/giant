...
export class Wizard extends React.Component<any, any> {
  ...
  onFinish = () => {
    if (this.getCurrentSlide().validate(this.getCurrentSlideRef().state)) {
      this.props.onFinish(
        Object.assign({}, this.state.data, this.getCurrentSlideRef().state),
      );
    }
  };
    ...
    return (
      <div>
        ...
        <div className="wizard__buttons">
          {this.state.index > 0 ? (
            <button className="btn" onClick={this.previousSlide}>
              Back
            </button>
          ) : (
            <div />
...
class WizardBreadcrumb extends React.Component<any, any> {
  static propTypes = {
    ...
    return (
      <div className="wizard__breadcrumb">
        ...
        <div
          className={
            this.props.done
              ? "wizard__breadcrumb-box--done"
              : "wizard__breadcrumb-box"
          }
        />
      </div>
    );
