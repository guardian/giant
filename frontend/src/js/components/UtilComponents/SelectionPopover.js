...
class SelectionPopover extends Component {
    ...
    computePopoverBox = () => {
        ...
        const targetStyle = targetElement.currentStyle || window.getComputedStyle(targetElement);
        ...
        const topPos = selectionBox.top - targetBox.top - popoverBox.height + marginTop;
        const leftPos = selectionBox.left - targetBox.left + selectionBox.width / 2 - popoverBox.width / 2 + marginLeft;
