...
export default class SearchFilter extends React.Component {
    ...
    toggleExpanded = () => {
        this.props.setFilterExpansionState(this.props.filter.key, !this.props.isExpanded);
    }
    ...
    renderOptions() {
        ...
        return this.props.filter.options.map((option) => (
            <SearchFilterOption
                ...
                aggBucket={agg ? agg.buckets.find(b => b.key === option.value) : undefined}
                option={option}
            ...
            <div className='sidebar__group'>
                <div className='sidebar__item' onClick={this.toggleExpanded}>
                    ...
                    <span className='sidebar__title__text'>
                        {this.props.filter.display ? this.props.filter.display : this.props.filter.value}
                    </span>
                </div>
                {this.renderOptions()}
            </div>
