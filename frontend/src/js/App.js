    ...
    return (
      <div>
        ...
        <div className="app__page">
          ...
          <div className="app__content">
            ...
            <Route
              path="/files/*"
              component={() => (
                <Directory currentResource={getCurrentResource()} />
              )}
            />
            ...
            <Route
              path="/settings/dataset-permissions"
            ...
            <Route
              path="/settings/all-ingestion-events"
              component={AllIngestionEvents}
            />
        ...
        <Route
          path="/resources/*"
          render={() => (
            <ResourceHandler currentResource={getCurrentResource()} />
          )}
        />
      </div>
    );
