...
export function getExtractionFailures(): ThunkAction<void, GiantState, null, MetricsAction | AppAction> {
    return dispatch => {
...
function recieveExtractionFailures(extractionFailures: ExtractionFailures): MetricsAction {
    return {
