...
function handleResourceResponse(dispatch: any, res: any) {
...
export function getResource(uri: string, highlightQuery?: string) {
  return (dispatch: any) => {
...
export function getBasicResource(uri: string, highlightQuery?: string) {
  return (dispatch: any) => {
...
export function getChildResource(uri: string) {
  return (dispatch: any) => {
...
export function setIsResourceLoading(isLoadingResource: boolean) {
  return {
...
function receiveResource(doc: any) {
  return {
...
function receiveChildResource(doc: any) {
  return {
...
function errorReceivingResource(error: any) {
  return {
    type: "APP_SHOW_ERROR",
