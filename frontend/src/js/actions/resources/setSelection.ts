...
export function getOffsetWithinHighlightedText(offsetWithinNode: number, initialTextNode: Node): number {
...
function freezeSelection(selection: Selection): ResourceRange {
    const anchorOffset = getOffsetWithinHighlightedText(selection.anchorOffset, selection.anchorNode!);
    const focusOffset = getOffsetWithinHighlightedText(selection.focusOffset, selection.focusNode!);
