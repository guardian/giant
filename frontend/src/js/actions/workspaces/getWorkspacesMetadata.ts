...
export function getWorkspacesMetadata(): ThunkAction<void, GiantState, null, WorkspacesAction | AppAction> {
    return (dispatch) => {
...
function receiveGetWorkspacesMetadata(workspacesMetadata: WorkspaceMetadata[]): WorkspacesAction {
    return {
