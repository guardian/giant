import { AddItemParameters, addResourceToWorkspace as addResourceToWorkspaceApi } from '../../services/WorkspaceApi';
...
export function addResourceToWorkspace(
    ...
    return dispatch => {
        return addResourceToWorkspaceApi(workspaceId, parentId, name, icon, parameters)
            .then(() => {
